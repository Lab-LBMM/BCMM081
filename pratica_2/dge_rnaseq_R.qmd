...
- Softwares
  ...
  - RSEM (Li e Dewey, 2011)
  - Salmon (Patro et al. 2017)
  - R/RStudio + DESeq2 (Love et al. 2014) + pheatmap () + edgeR
:::

## Dados de RNA-Seq - Wu et al. (2018) {.smaller}

::: {.incremental}
- Dados de RNA-Seq de leveduras
  - Mutante do fator de transcrição Rap1 - Auxin-Inducible degron (AID)
  - 1 μg total RNA com depleção de rRNA (Illumina RiboZero Gold rRNA Removal Kit - Yeast))
  - Diferentes kits de RNA-Seq: TruSeq Stranded Total RNA kit e TruSeq stranded mRNA kit (polyA)
  - Dados paired-end
:::
...
::: {.incremental}
- Dados de RNA-Seq Poli-A (indução com IAA vs. controle - DMSO)
  - Kit TruSeq stranded mRNA kit (strand-specific, "reverse")
  - Dados paired-end
  - Dados brutos de sequenciamento Illumina baixados do NCBI (SRA) com SRA Toolkit
  - Genoma de referência: *S. cerevisiae* (montagem R64-1-1, release 90)
  - Metadados associados às amostras (Poli-A)
:::
...
SRR6357087	Rap1-AID degron	induction 2 hours	polyA RNA-Seq	biological replicate 3
```
...
*Com `-l A`, salmon também detecta automaticamente o tipo de biblioteca de sequenciamento (exemplo: "detected_library_type": "ISR", no arquivo `aux_info/meta_info.json`).
...
## Alternativas - Nextflow rnseq (nf-core) {.smaller}
...
- Relatório de aula prática (15/09)
  - Escolher dados públicos de RNA-Seq para executar o pipeline de bioinformática e expressão diferencial;
  - OU: Selecionar outros dados de RNA-Seq do mesmo artigo da aula prática, com novas análises (etapas do pipeline e/ou expressão diferencial);
  - OU: Executar o mesmo pipeline, com modificações + expressão diferencial;
  - OU: Explorar diferentes estratégias para explorar os dados de expressão diferencial (com os mesmos dados);
  - OU: Explorar anotação funcional a partir dos resultados da aula prática (anotação e enriquecimento funcional);
  - OU: outras ideias ?
- Plantão de dúvidas dia 11/09, das 15h às 17h
...
- [Zhu, Anqi, Joseph G. Ibrahim, and Michael I. Love.](https://academic.oup.com/bioinformatics/article/35/12/2084/5159452) "Heavy-tailed prior distributions for sequence count data: removing the noise and preserving large differences." Bioinformatics 35.12 (2019): 2084-2092.
- [Chen, Shifu, et al.](https://academic.oup.com/bioinformatics/article/34/17/i884/5093234) "fastp: an ultra-fast all-in-one FASTQ preprocessor." Bioinformatics 34.17 (2018): i884-i890.
- [Deng, Zhi-Luo, et al.](https://academic.oup.com/nar/article/50/10/e60/6533611) "Rapid and accurate identification of ribosomal RNA sequences via deep learning." Nucleic acids research 50.10 (2022): e60-e60.
...
## Mais referências {.smaller}

- [Li, Bo, and Colin N. Dewey.](https://link.springer.com/article/10.1186/1471-2105-12-323) "RSEM: accurate transcript quantification from RNA-Seq data with or without a reference genome." BMC bioinformatics 12.1 (2011): 323.
- [Patro, Rob, et al.](https://www.nature.com/articles/nmeth.4197) "Salmon provides fast and bias-aware quantification of transcript expression." Nature methods 14.4 (2017): 417-419.
- [Kim, Daehwan, Ben Langmead, and Steven L. Salzberg.](https://www.nature.com/articles/nmeth.3317) "HISAT: a fast spliced aligner with low memory requirements." Nature methods 12.4 (2015): 357-360.
- [Wang, Liguo, Shengqin Wang, and Wei Li.](https://academic.oup.com/bioinformatics/article/28/16/2184/325191) "RSeQC: quality control of RNA-seq experiments." Bioinformatics 28.16 (2012): 2184-2185.
- [Dainat J. 2022](https://github.com/NBISweden/AGAT). Another Gtf/Gff Analysis Toolkit (AGAT): Resolve interoperability issues and accomplish more with your annotations. Plant and Animal Genome XXIX Conference.
